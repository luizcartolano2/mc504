/* This file contains the main program of MINIX as well as its shutdown 
code.
...
"(PAE) "
  ...
  printf("Inicializando SO customizada!\n");
  printf("Particion /mount/mc504 del disco duro seleccionada...\n");
}
