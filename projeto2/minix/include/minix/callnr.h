...
#define SPADMON_BASE                 0x1B00

#define IS_SPADMON_CALL(type)        (((type) & ~0xff) == SPADMON_BASE)

/* Message type 0 is traditionally reserved. */
#define SPADMON_GETPTABLE		(SPADMON_BASE + 1)
#define SPADMON_SETRUNNABLE		(SPADMON_BASE + 2)
#define SPADMON_SETSLEEP                (SPADMON_BASE + 3)
#define SPADMON_SETSTOPPED              (SPADMON_BASE + 4)
#define SPADMON_SETZOMBIE               (SPADMON_BASE + 5)
#define SPADMON_SETEXIT                 (SPADMON_BASE + 6)

#define NR_SPADMON_CALLS	   7
...
/* Calls forwarded from spadmon server. */
#define PM_SETRUNNABLE		(PM_BASE + 48)
#define PM_SETSLEEP        	(PM_BASE + 49)
#define PM_SETSTOPPED		(PM_BASE + 50)
#define PM_SETZOMBIE		(PM_BASE + 51)
#define PM_SETEXIT		(PM_BASE + 52)
