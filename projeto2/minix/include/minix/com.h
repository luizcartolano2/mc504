 ...
 *   0x1B00 - 0x1BFF	Spadmon request calls (see callnr.h)  
 *
...
#define SPADMON_PROC_NR ((endpoint_t) 11) /* spadmon */
...
/*Spadmon system calls that access the kernel process table */

# define SYS_SETBLOCKED (KERNEL_CALL + 58) 	/*sys_setblocked()*/
# define SYS_SETRUNNABLE (KERNEL_CALL + 59) 	/*sys_setrunnable()*/
# define SYS_SETSLEEP (KERNEL_CALL + 60)	/*sys_setsleep()*/
/* Total */
